  ...
  if($img_promo != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, '../../assets/img/promo/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE promo SET title_promo = '$title_promo', desc_promo = '$desc_promo', img_promo = '$nama_gambar_baru'";
                   $query .= "WHERE id_promo = '$id_promo'";
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE promo SET title_promo = '$title_promo', desc_promo = '$desc_promo'";
      $query .= "WHERE id_promo = '$id_promo'";
      $result = mysqli_query($conn, $query);
      // periska query apakah ada error
      if(!$result){
